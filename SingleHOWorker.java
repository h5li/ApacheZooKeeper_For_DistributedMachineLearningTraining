...
class SingleHOWorker implements Watcher, StatCallback {
    public ZooKeeper zk;
    public int id;
    ...
    public SingleHOWorker(String addrs, int id, int numWorker) throws KeeperException, IOException {
    ...
    public static void main(String[] args) throws KeeperException, InterruptedException, IOException {
        ...
        for(int k = 0; k < numEpochs; k++) {
            ...
            ProcessBuilder pb = new ProcessBuilder("python", "compute_gradient.py", args[3], "0");
            ...
            System.out.println("Worker " + 0 + " waited for python Process for " + (pythonEndTime - pythonStartTime) + " in epoch " + k);
            ...
            worker.writeGradToFile();
            long writeGradEndTime = System.nanoTime();
            System.out.println("Worker " + worker.id + " spends " + (writeGradEndTime - writeGradStartTime) + " writing to file" + worker.id);
